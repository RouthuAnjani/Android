...
public class UpdateEmployeeActivity extends AppCompatActivity {
    ...
    private void updateEmployee() {
        ...
        if (employeeId != -1) {
            ...
            Uri selectedImageUri = getImageUri(); // Implement this method to retrieve the selected image URI

            // Pass the image URI to the updateEmployee() method
            long id = databaseHelper.updateEmployee(updatedEmployee, selectedImageUri != null ? Uri.parse(selectedImageUri.toString()) : null);
            if (id != -1) {
